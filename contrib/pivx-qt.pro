...
RESOURCES += src/qt/stipend.qrc src/qt/stipend_locale.qrc

TRANSLATIONS += src/qt/locale/stipend_bg.ts \
                src/qt/locale/stipend_de.ts \
                src/qt/locale/stipend_en.ts \
                src/qt/locale/stipend_es.ts \
                src/qt/locale/stipend_fi.ts \
                src/qt/locale/stipend_fr.ts \
                src/qt/locale/stipend_it.ts \
                src/qt/locale/stipend_ja.ts \
                src/qt/locale/stipend_pl.ts \
                src/qt/locale/stipend_pt.ts \
                src/qt/locale/stipend_ru.ts \
                src/qt/locale/stipend_sk.ts \
                src/qt/locale/stipend_sv.ts \
                src/qt/locale/stipend_vi.ts \
                src/qt/locale/stipend_zh_CN.ts \
                src/qt/locale/stipend_zh_TW.ts
