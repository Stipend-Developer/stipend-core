...
In order to support loading of multiple wallets in stipend-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stipend.cpp.
...
Changes to stipend.cpp
----------------------
stipend.cpp is the entry point into stipend-qt, and as such, will require some minor modifications to provide hooks for
