UNIX BUILD NOTES
====================
Some notes on how to build Stipend in Unix.

Note
---------------------
Always use absolute paths to configure and compile stipend and the dependencies,
...
This will build stipend-qt as well if the dependencies are met.
...
memory available when compiling Stipend Core. With 512MB of memory or less
...
Notes
-----
The release is built with GCC and then "strip stipendd" to strip the debug
