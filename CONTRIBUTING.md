Contributing to Stipend Core
============================

The Stipend Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Stipend Core project, and is not to be
confused with overall Stipend Network Protocol consensus changes.

Whether a pull request is merged into Stipend Core rests with the project merge
...
Patches that change Stipend consensus rules are considerably more involved than
...
Where a patch set proposes to change the Stipend consensus, it must have been
...
The project leader is the release manager for each Stipend Core release.
