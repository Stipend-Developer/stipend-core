                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSPDPathCustom = GetArg("-zspdbackuppath", "");
    ...
    if(!strzSPDPathCustom.empty()) {
        ui->wallet_customzspdbackuppath->setText(QString::fromStdString(strzSPDPathCustom));
        ui->wallet_customzspdbackuppath_label->setVisible(true);
        ui->wallet_customzspdbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSPDPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Stipend RPC console.") + "<br>" +
