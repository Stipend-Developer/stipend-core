...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zspdTracker->HasMintTx(hash))) {
            //zSPD stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZSPD;
...
bool IsZSPDType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZSPD:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZSPD || type == TransactionRecord::MNReward) {
