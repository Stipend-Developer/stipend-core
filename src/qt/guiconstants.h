...
/* Stipend GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Stipend"
#define QAPP_ORG_DOMAIN "stipend.me"
#define QAPP_APP_NAME_DEFAULT "Stipend-Qt"
#define QAPP_APP_NAME_TESTNET "Stipend-Qt-testnet"
