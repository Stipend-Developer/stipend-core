...
/** Utility functions used by the Stipend Qt UI.
 */
namespace GUIUtil
{
...
// Render Stipend addresses in monospace font
...
// Parse "stipend:" URI into recipient object, return true on successful parsing
