...
QT_TRANSLATE_NOOP("pivx-core", "(46978 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("pivx-core", "(default: %s)"),
QT_TRANSLATE_NOOP("pivx-core", "(default: 1)"),
QT_TRANSLATE_NOOP("pivx-core", "(must be 46978 for mainnet)"),
...
QT_TRANSLATE_NOOP("pivx-core", "Copyright (C) 2020-%i The Stipend Core Developers"),
...
QT_TRANSLATE_NOOP("pivx-core", "Enable precomputation of zSPD spends and stakes (0-1, default %u)"),
...
QT_TRANSLATE_NOOP("pivx-core", "Error loading wallet.dat: Wallet requires newer version of Stipend Core"),
...
QT_TRANSLATE_NOOP("pivx-core", "Fee (in SPD/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("pivx-core", "Initialization sanity check failed. Stipend Core is shutting down."),
...
QT_TRANSLATE_NOOP("pivx-core", "Recalculating SPD supply..."),
QT_TRANSLATE_NOOP("pivx-core", "Recalculating minted zSPD..."),
QT_TRANSLATE_NOOP("pivx-core", "Recalculating spent zSPD..."),
QT_TRANSLATE_NOOP("pivx-core", "Receive and display P2P network alerts (default: %u)"),
QT_TRANSLATE_NOOP("pivx-core", "Reindex the SPD and zSPD money supply statistics"),
...
QT_TRANSLATE_NOOP("pivx-core", "Syncing zSPD wallet..."),
...
QT_TRANSLATE_NOOP("pivx-core", "Value is below the smallest available denomination (= 1) of zSPD"),
...
QT_TRANSLATE_NOOP("pivx-core", "Wallet needed to be rewritten: restart Stipend Core to complete"),
