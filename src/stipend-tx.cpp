...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Stipend Core stipend-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  stipend-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded stipend transaction") + "\n" +
                               "  stipend-tx [options] -create [commands]   " + _("Create hex-encoded stipend transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded stipend transaction
