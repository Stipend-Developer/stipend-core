...
/**
 * Stipend RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzspdseed(const UniValue& params, bool fHelp);
extern UniValue getzspdseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzspd(const UniValue& params, bool fHelp);
extern UniValue dzspdstate(const UniValue& params, bool fHelp);
