...
UniValue preparebudget(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 6)
        throw std::runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("preparebudget", "\"test-proposal\" \"https://www.stipend.me\" 2 820800 \"sRJGzdWvQJWJpdvWrt6f1UUBpBgAXKRuv8\" 500") +
            HelpExampleRpc("preparebudget", "\"test-proposal\" \"https://www.stipend.me\" 2 820800 \"sRJGzdWvQJWJpdvWrt6f1UUBpBgAXKRuv8\" 500"));
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 7)
        throw std::runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"stipend-address\" monthly-payment \"fee-tx\"\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("submitbudget", "\"test-proposal\" \"https://www.stipend.me\" 2 820800 \"sRJGzdWvQJWJpdvWrt6f1UUBpBgAXKRuv8\" 500") +
            HelpExampleRpc("submitbudget", "\"test-proposal\" \"https://www.stipend.me\" 2 820800 \"sRJGzdWvQJWJpdvWrt6f1UUBpBgAXKRuv8\" 500"));
