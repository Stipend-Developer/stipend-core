...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000035246f679f3b9d0885d69cf94cdc8fa55208988b732587d26da783bbabf"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 46978;
        bnProofOfWorkLimit = ~uint256(0) >> 9; // Stipend starting difficulty is 1 / 2^12
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c10e83b2703cccdeaf7dbd62dd5855ac7c10bd055814ce121ba32607d573b8810c02c0582aed05b4deb9c4b77b26d92428c61256cd42774babea0a073b2ed0c9") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1547320086;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 438729;
        ...
        */
        ...
        assert(hashGenesisBlock == uint256("0x00000975d509312af3962bb34f0ee4e6f4220f0f7b0c1d78bdf3f13c3e7b38b6"));
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zspd to be stakable
...
public:
    CTestNetParams()
    {
        ...
        */
        ...
        assert(hashGenesisBlock == uint256("0x0000099d1eb29cf25fc63e2e4ba1a6cbcea9ddd5aae6eb1b3f957b4bb9a74657"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet stipend addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet stipend script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet stipend BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet stipend BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet stipend BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        */
        ...
        assert(hashGenesisBlock == uint256("0x2bc7cd99ae1af51277d6a53f53c2575efef4347e4210438cd3998df0d0bf7e14"));
