...
#   c) node1 mines 32 blocks, so now node 0 has 60001spd, node 1 has 4250spd, node2 has none.
#   d) node0 sends 601 spd to node2, in two transactions (301 spd, then 300 spd).
